...
/* const App = () => 
    <main>
        ...
        <div class="container">
            <h1 class="display-4">Click on image to start!</h1>
            <p class="lead">keep clicking on different images to earn points. If you click on the same image twice, your score gets reset. get 12 points to win</p>
        </div>
        </div>
        </header>
